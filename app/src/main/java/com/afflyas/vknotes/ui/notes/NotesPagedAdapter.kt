...
import com.afflyas.vknotes.databinding.ItemNoteFooterBinding
...
class NotesPagedAdapter(private val retryCallback: RetryCallback,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            R.layout.item_note_footer -> {
                val binding: ItemNoteFooterBinding = DataBindingUtil
                        .inflate(LayoutInflater.from(parent.context), R.layout.item_note_footer, parent, false)
    ...
    override fun getItemViewType(position: Int): Int {
        return when(position){
            ...
            itemCount - 1 -> R.layout.item_note_footer
    ...
    companion object {
        ...
        /**
         * ViewHolder that contains binding with `item_note_footer.xml` layout
         */
        class ItemFooterViewHolder(val binding: ItemNoteFooterBinding) : RecyclerView.ViewHolder(binding.root)
